...
// CONCATENATED MODULE: ./src/directives/LongTouch.js
...
var clearLongTouchTimeout = function clearLongTouchTimeout() {
  if (longTouchTimeout) {
    clearTimeout(longTouchTimeout);
  }
};

var startLongTouchTimeout = function startLongTouchTimeout(timeoutMs, cb) {
  clearLongTouchTimeout();
  longTouchTimeout = setTimeout(cb, timeoutMs);
};

/* harmony default export */ var LongTouch = (function (tocuhDuration) {
  return {
    bind: function bind(el, _ref) {
      ...
      if (value && typeof value === 'function') {
        // events callbacks
        el._vue_longtouch_ts_cb = function (e) {
          e.preventDefault();
          startLongTouchTimeout(tocuhDuration, value);
        };

        el._vue_longtouch_tm_cb = function (e) {
          e.preventDefault();
          clearLongTouchTimeout();
        };

        el._vue_longtouch_te_cb = function (e) {
          e.preventDefault();
          clearLongTouchTimeout();
        }; // add event listeners
...
//# sourceMappingURL=vuelongtouch.umd.js.map